...
json_folder_path = 'D:\IdeaProject\PyCharm\yolov5\labelimg\json/'  # json文件的路径
txt_path = 'D:\IdeaProject\PyCharm\yolov5\labelimg\label/'
...
def decode_json(json_floder_path, json_name):
    txt_name = txt_path + json_name[0:-5] + '.txt'  # 生成txt文件你想存放的路径
